...
class PHPExcel_Chart_DataSeries
{
     ...
     * @var array of PHPExcel_Chart_DataSeriesValues
     */
    private $_plotBubbleChartSizes = array();
     ...
     * @var array of PHPExcel_Chart_DataSeriesValues
     */
    private $_plotBubbleChartLabels = array();

    private $_plotBubbleScale = 100;
    /**
                                   ...
                                   )
    {
        ...
        $this->_plotBubbleChartSizes = $plotBubbleChartSizes;
        $this->_plotBubbleChartLabels = $plotBubbleChartLabels;
        $this->_plotBubbleScale = $plotBubbleScale;
    }
    ...
    public function getBubbleChartSizes() {
        return $this->_plotBubbleChartSizes;
    }
    ...
    public function getBubbleChartLabels() {
        return $this->_plotBubbleChartLabels;
    }
    ...
    public function getBubbleChartSizesByIndex($index) {
        $keys = array_keys($this->_plotBubbleChartSizes);
        if (in_array($index,$keys)) {
            return $this->_plotBubbleChartSizes[$index];
        } elseif(isset($keys[$index])) {
            return $this->_plotBubbleChartSizes[$keys[$index]];
        }
        return false;
    }
    ...
    public function getBubbleChartLabelsByIndex($index) {
        $keys = array_keys($this->_plotBubbleChartLabels);
        if (in_array($index,$keys)) {
            return $this->_plotBubbleChartLabels[$index];
        } elseif(isset($keys[$index])) {
            return $this->_plotBubbleChartLabels[$keys[$index]];
        }
        return false;
    }
    ...
    public function getPlotBubbleChartSizesSeriesCount() {
        return count($this->_plotBubbleChartSizes);
    }
    ...
    public function getPlotBubbleChartLabelsSeriesCount() {
        return count($this->_plotBubbleChartLabels);
    }
    ...
    public function refresh(PHPExcel_Worksheet $worksheet) {
        ...
        foreach($this->_plotBubbleChartSizes as $plotBubbleChartSizes) {
            if ($plotBubbleChartSizes !== NULL)
                $plotBubbleChartSizes->refresh($worksheet, TRUE);
        }
        foreach($this->_plotBubbleChartLabels as $plotBubbleChartLabels) {
